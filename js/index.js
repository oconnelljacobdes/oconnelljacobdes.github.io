...
$('.tile').click(function(){
   ...
   switch(data){
	   ...
	   case 'marquettecastingscooking':
		$('.showcase').html('<div class="content"><h1>Marquette Castings Cooking</h1>           <div class="separator"></div>           <div class="copy"> This is a currently ongoing marketing series for Marquette Castings where we are using some of their cookware for instructional cooking videos showcased on various social media platforms. </div></div> <iframe src="https://player.vimeo.com/video/235619128" width="800" height="450" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <iframe src="https://player.vimeo.com/video/239526262" width="800" height="450" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <iframe src="https://player.vimeo.com/video/235914570" width="800" height="450" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
       break;
