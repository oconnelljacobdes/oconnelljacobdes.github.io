...
$('.tile').click(function(){
   ...
   switch(data){
	   case 'reel':
        $('.showcase').html('<div class="content"><h1>Reel 18</h1><div class="copy">My 2018 motion graphics reel. A collection of work from the past year.</div></div></div><iframe src="https://player.vimeo.com/video/283786610" width="800" height="450" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>');
       break;
	   
	   case 'closeshave':
        $('.showcase').html('<div class="content"><h1>Close Shave</h1><div class="copy">A short animation advertisement for a new beard trimmer from Brio.</div></div></div><iframe src="https://player.vimeo.com/video/279470174?color=ffffff&title=0&byline=0&portrait=0" width="800" height="450" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>');
       break;
